...
const journeyPhases = [
  {
    ...
    milestones: [
      "You sign—we confirm within hours",
      "Kit ships next business day",
      "Your CSM sends a personal welcome",
      "Kickoff call scheduled around you",
    ],
    successMetric: "You'll know you made the right call",
  ...
  },
  {
    ...
    days: "Days 4-10",
    phaseNumber: 2,
    tagline: "Wait... this actually works?",
    descriptionParts: [
      { text: "72 hours from unboxing to proof.", highlight: true },
      { text: " Your kit arrives, you walk through setup live with your CSM, and within 3 days your first AP is online in the wibipOS dashboard. You'll see it with your own eyes before betting a customer on it." },
    ],
    milestones: [
      "Kit arrives—unboxing guide included",
      "30-min live setup with your CSM",
      "First AP online in wibipOS",
      "Day 10 validation—all questions answered",
    ],
    successMetric: "Proof in 72 hours",
  ...
  },
  {
    ...
    days: "Days 11-20",
    phaseNumber: 3,
    tagline: "First customer site. Stakes are real.",
    descriptionParts: [
      { text: "Real users. Real traffic. You didn't do it alone.", highlight: true },
      { text: " You plan and execute your first production deployment at a customer site. Your CSM is on standby during go-live—no orphaned deployment, no finger-crossing." },
    ],
    milestones: [
      "We plan the deployment together",
      "Site prep with async support",
      "Go-live—your CSM on standby",
      "Post-deployment review to lock it in",
    ],
    successMetric: "First customer site: live",
  ...
  },
  {
    ...
    days: "Days 21-30",
    phaseNumber: 4,
    tagline: "Invoice sent. One stack. My margin.",
    descriptionParts: [
      { text: "The pilot is dead. Long live the revenue.", highlight: true },
      { text: " You send your first invoice. Payment confirmed. One consolidated platform, one relationship, one margin you actually keep." },
    ],
    milestones: [
      "Billing integration—we walk you through",
      "Invoice configuration set up",
      "First invoice sent",
      "Day 30 Business Review—ROI confirmed",
    ],
    successMetric: "First revenue: booked",
  ...
  },
  {
    ...
    days: "Day 31+",
    phaseNumber: 5,
    tagline: "Systems humming. Expansion unlocked.",
    descriptionParts: [
      { text: "From skeptic to advocate. Your story, not ours.", highlight: true },
      { text: " You consolidated the stack, maximized the margin, and proved the model. Now it's about scale—new sites, new customers, new markets. Quarterly business reviews keep the momentum growing." },
    ],
    milestones: [
      "Expansion roadmap presented",
      "Your success story captured",
      "Quarterly Business Reviews scheduled",
      "New markets, new sites, your pace",
    ],
    successMetric: "Scale: unlocked",
