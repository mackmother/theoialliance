// BACKUP: Original Hero before Alliance announcement (December 2024)
// To restore: copy this file to Hero.tsx
      ...
      <Container className="relative z-10 py-16 md:py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-dark-300 mb-4 leading-relaxed max-w-2xl mx-auto">
            wibipOS unifies legacy gear and OpenLAN into one enterprise control plane—win multi-vendor deals with production-grade tooling, not just a dashboard.
          </p>
