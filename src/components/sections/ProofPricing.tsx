    ...
    <Section id="proof" background="default" spacing="lg" divider>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-primary text-lg font-medium">We proved them wrong.</p>
        </div>
        ...
        <div className="mb-8 p-5 rounded-xl bg-dark-800/30 border border-white/[0.04]">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="text-center">
              <p className="text-primary font-semibold text-sm mb-1">LIVE SDK Engineers</p>
            ...
            <div className="text-center">
              <p className="text-primary font-semibold text-sm mb-1">Dynamic Roadmap</p>
            ...
            <div className="text-center">
              <p className="text-primary font-semibold text-sm mb-1">BYOTS</p>
        ...
        <div className="pt-6 border-t border-white/[0.04]">
          <p className="text-center text-xl md:text-2xl text-dark-200 mb-6" style={{ letterSpacing: "-0.01em" }}>
            If a 5-person team did this, <span className="text-primary font-semibold">what could yours do?</span>
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-primary border border-primary/30 rounded-lg bg-primary/5 hover:bg-primary/10 hover:border-primary/50 transition-all"
            >
